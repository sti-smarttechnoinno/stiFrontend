...
const PROOFS = [
  { icon: MapPin, title: "Une présence nationale", text: "Un réseau de distribution étendu, réactif et proche de vos besoins partout en Algérie." },
  { icon: ShieldCheck, title: "Des marques de référence", text: "Partenaire officiel et distributeur agréé des leaders mondiaux Ooredoo et VIVO." },
  { icon: HeartHandshake, title: "Un accompagnement durable", text: "Une relation de confiance, un support technique dédié et un engagement qualité continu." },
];
    ...
    <section id="a-propos" aria-labelledby="why-heading" className="py-20 sm:py-28 bg-gray-50/60">
      <div className="mx-auto grid max-w-[1320px] items-center gap-12 px-6 lg:px-8 lg:grid-cols-2 lg:gap-16">
        <div>
          ...
          >
            Pourquoi choisir STI ?
          </h2>
          <p className="mt-4 max-w-md text-base text-gray-500 leading-relaxed">
            Plus de 15 ans d&apos;expertise et de partenariats solides au service de l&apos;écosystème technologique algérien.
          </p>
