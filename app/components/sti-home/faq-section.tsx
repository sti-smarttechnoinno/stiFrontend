      ...
      <div className="mx-auto max-w-[1320px] px-6 lg:px-8">
        <div className="mb-14 text-center max-w-2xl mx-auto">
          ...
          <p className="mt-3 text-base text-gray-500 leading-relaxed">
            Trouvez des réponses claires sur la distribution, les produits et l&apos;accompagnement STI.
          </p>
        </div>
          ...
          <aside className="sticky top-24">
            <div className="relative overflow-hidden rounded-[24px] border border-gray-100 bg-[#102039] p-8 sm:p-9 text-white shadow-[0_8px_32px_rgba(16,32,57,0.12)]">
              ...
              <p className="mt-3 text-sm text-white/70 leading-relaxed">
                Notre équipe commerciale et technique est à votre écoute pour vous orienter.
              </p>
              <a
