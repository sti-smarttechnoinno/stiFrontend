...
export function Hero() {
  ...
  const dividerLeft = active === "ooredoo" ? "65%" : active === "vivo" ? "35%" : "50%"
  ...
  return (
    <section
      id="accueil"
      aria-label="Deux univers STI : Ooredoo et VIVO"
    ...
    >
      ...
      <div className="bg-charcoal px-6 py-8 text-center md:hidden">
        <p className="text-[0.7rem] font-semibold tracking-[0.35em] text-crimson">SMART TECHNOLOGY INNOVATION</p>
        ...
        <p className="mx-auto mt-2 max-w-sm text-pretty text-sm leading-relaxed text-white/80">
          Accédez directement à nos produits et solutions Ooredoo et VIVO.
        </p>
      </div>
      ...
      <div className="pointer-events-none absolute left-1/2 top-6 z-30 hidden w-[92%] max-w-xl -translate-x-1/2 text-center md:block">
        <p className="text-xs font-semibold tracking-[0.4em] text-crimson">SMART TECHNOLOGY INNOVATION</p>
        <div className="my-3 flex justify-center">
          <Image
            src="/assets/logo.png"
            alt="STI — Smart Technologie Innovation"
      ...
      <div className="flex h-full w-full flex-col md:flex-row">
        ...
        <div
          role="button"
          tabIndex={0}
          aria-label="Accéder à l'espace Ooredoo"
          ...
          className="relative h-[48vh] shrink-0 basis-auto cursor-pointer text-left outline-none ring-inset transition-[flex-grow] duration-[600ms] focus-visible:ring-4 focus-visible:ring-crimson md:h-full md:basis-0"
        ...
        <div
          role="button"
          tabIndex={0}
          aria-label="Accéder à l'espace VIVO"
      ...
      >
        <div className="relative h-full w-px bg-gradient-to-b from-transparent via-crimson to-transparent">
          <div className="absolute left-1/2 top-1/2 flex h-11 w-11 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-crimson/40 bg-white shadow-lg">
            ...
            <ArrowRight className="relative h-4 w-4 text-crimson" />
          </div>
        </div>
      </div>
